...
def main():
    ...
    print('This is how far the model moves cars, not how often it is right -')
    print('the two are different numbers and only the second is accuracy.')
    print('For scale: over the 52 races v2.6 scored, the grid finished an')
