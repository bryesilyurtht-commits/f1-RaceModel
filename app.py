...
FLAG_LABELS = {
    ...
    'DOUBLE_STACK_ENABLED': 'Avoid stacking teammates in the same stop',
    'TEAM_ORDERS_ENABLED': 'Hold station between teammates on the same plan',
    ...
    with st.sidebar:
        ...
        groups = {
            ...
            'Racing': ['START_MODEL', 'LOCK_START_ORDER', 'EVOLUTION_ENABLED',
                       ...
                       'DOUBLE_STACK_ENABLED', 'TEAM_ORDERS_ENABLED'],
